 ...
 * @author priyankb
 */
public class DSRequestsRandomNode implements Event {

    private byte type = Protocol.DS_REQUESTS_RANDOMNODE;
    ...
    public DSRequestsRandomNode(byte[] data) throws IOException {
