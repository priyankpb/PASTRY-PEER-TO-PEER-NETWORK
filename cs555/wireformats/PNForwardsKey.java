 ...
 * @author priyankb
 */
public class PNForwardsKey implements Event {

    private byte type = Protocol.PN_FORWARDS_KEY;
    ...
    public PNForwardsKey(byte[] data) throws IOException {
