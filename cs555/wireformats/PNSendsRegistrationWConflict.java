 ...
 * @author priyankb
 */
public class PNSendsRegistrationWConflict implements Event {

    private byte type = Protocol.PN_SENDS_REGISTRATION_W_CONFLICT;
    private RoutingEntry newPeer;

    public PNSendsRegistrationWConflict() {
    }
    ...
    public PNSendsRegistrationWConflict(byte[] data) throws IOException {
