 ...
 * @author priyankb
 */
public class PNNotifiesLeafNodes implements Event {

    private byte type = Protocol.PN_NOTIFIES_LEAFNODES;
    private char direction;
    private RoutingEntry leafNode;

    public PNNotifiesLeafNodes() {
    }
    ...
    public PNNotifiesLeafNodes(byte[] data) throws IOException {
