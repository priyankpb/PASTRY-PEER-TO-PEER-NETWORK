 ...
 * @author priyankb
 */
public class DSSendsKeyRead implements Event {

    private byte type = Protocol.DS_SENDS_KEY_READ;
    ...
    public DSSendsKeyRead(byte[] data) throws IOException {
