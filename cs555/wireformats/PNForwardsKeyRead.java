 ...
 * @author priyankb
 */
public class PNForwardsKeyRead implements Event {

    private byte type = Protocol.PN_FORWARDS_KEY_READ;
    ...
    public PNForwardsKeyRead(byte[] data) throws IOException {
