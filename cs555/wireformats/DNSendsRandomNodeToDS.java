 ...
 * @author priyankb
 */
public class DNSendsRandomNodeToDS implements Event {

    private byte type = Protocol.DN_SENDS_RANDOMNODE_TO_DS;
    private String fileName;
    private String key;
    private RoutingEntry randomNode;

    public DNSendsRandomNodeToDS() {
    }
    ...
    public DNSendsRandomNodeToDS(byte[] data) throws IOException {
